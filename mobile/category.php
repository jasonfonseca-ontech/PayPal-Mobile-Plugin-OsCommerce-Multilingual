...
<ul data-role="listview" data-inset="true" style="margin-top:15px;">
	<?php
		...
		// check to see if there are deeper categories within the current category
                // 
                          //only take the stuff from the last category
                          $category_links = array(reset(array_reverse($cPath_array)));
                          // To display all the siblings of the current item, uncomment the following line
